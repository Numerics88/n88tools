...
examples:
  ...
  In the following example, the default variables will be extracted from
...
A '+' sign indicates variables that are extracted in the default set.
...
variables corresponding to values in table "Nodal Forces":
    ...
    +fx_median_ns%n   The median force in the x direction over all
                     nodes in the nth node set.
    fx_avg_ns%n       The average force in the x direction over all
                     nodes in the nth node set.
    ...
    +fy_median_ns%n   The median force in the y direction over all
                     nodes in the nth node set.
    fz_avg_ns%n       The average force in the z direction over all
                     nodes in the nth node set.
        ...
        for key,value in lookups.items():
            ...
            if not key_added:
                ...
                if s:
                    ...
                    key_added = True
            if not key_added:
                # From version 7, skip Pistoia unless specifically requested (last row).
                # From version 9, we ensure only key outputs are provided by default (rows except last row).
                if not (key in [
                                "dx_els", "dy_els", "dz_els",
                                "num_nodes_per_els", "dim_of_problem",
                                "eps_ave_xx", "eps_stddev_xx", "eps_min_xx", "eps_max_xx", "eps_skew_xx", "eps_kurt_xx", "eps_median_xx", "eps_perc05_xx", "eps_perc25_xx", "eps_perc75_xx", "eps_perc95_xx", "eps_ave_yy", "eps_stddev_yy", "eps_min_yy", "eps_max_yy", "eps_skew_yy", "eps_kurt_yy", "eps_median_yy", "eps_perc05_yy", "eps_perc25_yy", "eps_perc75_yy", "eps_perc95_yy", "eps_ave_zz", "eps_stddev_zz", "eps_min_zz", "eps_max_zz", "eps_skew_zz", "eps_kurt_zz", "eps_median_zz", "eps_perc05_zz", "eps_perc25_zz", "eps_perc75_zz", "eps_perc95_zz",
                                "gam_ave_yz", "gam_stddev_yz", "gam_min_yz", "gam_max_yz", "gam_skew_yz", "gam_kurt_yz", "gam_median_yz", "gam_perc05_yz", "gam_perc25_yz", "gam_perc75_yz", "gam_perc95_yz", "gam_ave_zx", "gam_stddev_zx", "gam_min_zx", "gam_max_zx", "gam_skew_zx", "gam_kurt_zx", "gam_median_zx", "gam_perc05_zx", "gam_perc25_zx", "gam_perc75_zx", "gam_perc95_zx", "gam_ave_xy", "gam_stddev_xy", "gam_min_xy", "gam_max_xy", "gam_skew_xy", "gam_kurt_xy", "gam_median_xy", "gam_perc05_xy", "gam_perc25_xy", "gam_perc75_xy", "gam_perc95_xy",
                                "sig_ave_xx", "sig_stddev_xx", "sig_min_xx", "sig_max_xx", "sig_skew_xx", "sig_kurt_xx", "sig_median_xx", "sig_perc05_xx", "sig_perc25_xx", "sig_perc75_xx", "sig_perc95_xx", "sig_ave_yy", "sig_stddev_yy", "sig_min_yy", "sig_max_yy", "sig_skew_yy", "sig_kurt_yy", "sig_median_yy", "sig_perc05_yy", "sig_perc25_yy", "sig_perc75_yy", "sig_perc95_yy", "sig_ave_zz", "sig_stddev_zz", "sig_min_zz", "sig_max_zz", "sig_skew_zz", "sig_kurt_zz", "sig_median_zz", "sig_perc05_zz", "sig_perc25_zz", "sig_perc75_zz", "sig_perc95_zz", 
                                "sig_ave_yz", "sig_stddev_yz", "sig_min_yz", "sig_max_yz", "sig_skew_yz", "sig_kurt_yz", "sig_median_yz", "sig_perc05_yz", "sig_perc25_yz", "sig_perc75_yz", "sig_perc95_yz", "sig_ave_zx", "sig_stddev_zx", "sig_min_zx", "sig_max_zx", "sig_skew_zx", "sig_kurt_zx", "sig_median_zx", "sig_perc05_zx", "sig_perc25_zx", "sig_perc75_zx", "sig_perc95_zx", "sig_ave_xy", "sig_stddev_xy", "sig_min_xy", "sig_max_xy", "sig_skew_xy", "sig_kurt_xy", "sig_median_xy", "sig_perc05_xy", "sig_perc25_xy", "sig_perc75_xy", "sig_perc95_xy",
                                "sed_perc05",	"sed_perc25",	"sed_perc75",	"sed_perc95",
                                "svm_perc05",	"svm_perc25",	"svm_perc75",	"svm_perc95",
                                "fx_avg_ns%n", "fy_avg_ns%n", "fz_avg_ns%n",
                                "pis_stiffx", "pis_stiffy", "pis_stiffz", "pis_fx_fail", "pis_fy_fail", "pis_fz_fail"
                               ]):
                    keys[key] = value
    else:
